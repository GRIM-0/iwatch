    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"><a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'tv-series.php' ? 'active' : ''; ?>" href="tv-series.php">TV Series
            </a></li>
  ...
  <div class="container mt-4">
    ...
    <div class="row">
      <?php foreach ($movies as $movie) {
        ...
        echo '<div class="card">';
        echo '<img src="https://image.tmdb.org/t/p/w500' . $movie["poster_path"] . '" class="card-img-top" alt="' . $movie["title"] . '">';
